...
impl HealthMonitorBuilder {
    ...
    pub fn with_supervisor_api_cycle(&mut self, cycle_duration: core::time::Duration) {
    ...
    pub fn with_internal_processing_cycle(&mut self, cycle_duration: core::time::Duration) {
...
mod tests {
    ...
    fn hm_with_taken_monitors_starts() {
        ...
        health_monitor_builder.add_deadline_monitor("test_monitor".into(), deadline::DeadlineMonitorBuilder::new());
