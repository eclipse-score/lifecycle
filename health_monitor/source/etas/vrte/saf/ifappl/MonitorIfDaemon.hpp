...
public:
    ...
    void checkForNewData(const etas::vrte::saf::timers::NanoSecondType f_syncTimestamp) noexcept(true);
...
private:
    ...
    bool pushNewDataToCheckpointObservers(const etas::vrte::saf::timers::NanoSecondType f_syncTimestamp);
