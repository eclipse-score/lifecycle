...
#include "etas/vrte/saf/ipc/IpcServer.hpp"
...
{
    etas::vrte::saf::timers::NanoSecondType timestamp{0U};  ///< Timestamp
    ...
    CheckpointBufferElement(etas::vrte::saf::timers::NanoSecondType f_timestamp,
