...
launch_manager_config = rule(
    ...
    attrs = {
        ...
        "lm_schema": attr.label(
            ...
            default = Label("//score/launch_manager/src/daemon/src/configuration:lm_flatcfg_fbs"),
            doc = "Launch Manager fbs file to use",
        ),
        "hm_schema": attr.label(
            allow_single_file = [".fbs"],
            default = Label("//score/launch_manager/src/daemon/src/alive_monitor:am_flatcfg_fbs"),
            doc = "HealthMonitor fbs file to use",
        ),
        "hmcore_schema": attr.label(
            allow_single_file = [".fbs"],
            default = Label("//score/launch_manager/src/daemon/src/alive_monitor:am_core_flatcfg_fbs"),
