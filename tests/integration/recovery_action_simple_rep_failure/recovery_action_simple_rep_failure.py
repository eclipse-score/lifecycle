...
def test_recovery_action_simple_rep_failure(target, setup_test, test_output_dir, remote_test_dir):
    """
    Objective: Verifies that recovery action is executed when the simple reporting of kRunning is not successful.
