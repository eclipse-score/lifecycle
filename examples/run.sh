...
LM_BINARY="$BAZEL_BIN/score/mw/launch_manager/launch_manager"
...
mkdir -p tmp/lib
cp $BAZEL_BIN/score/mw/launch_manager/process_state_client_lib/libprocess_state_client.so tmp/lib/
cp $BAZEL_BIN/score/mw/launch_manager/lifecycle_client_lib/liblifecycle_client.so tmp/lib/
